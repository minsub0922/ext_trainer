#!/usr/bin/env bash
##############################################################################
# Run SFT training for Qwen3-0.6B with LoRA
#
# Usage:
#   bash scripts/train/run_sft_qwen3.sh [--config path/to/config.yaml] [--dry-run]
#
# Environment variables:
#   CONFIG_PATH: Path to training config (default: configs/sft/qwen3_lora_sft.yaml)
#
# Examples:
...
# Default config path
CONFIG_PATH="${CONFIG_PATH:-${PROJECT_ROOT}/configs/sft/qwen3_lora_sft.yaml}"
DRY_RUN=false
...
echo "============================================================"
echo "Qwen3-0.6B LoRA SFT Training"
echo "============================================================"
echo ""
...
# Run training
echo "Starting Qwen3-0.6B LoRA SFT training..."
echo ""
